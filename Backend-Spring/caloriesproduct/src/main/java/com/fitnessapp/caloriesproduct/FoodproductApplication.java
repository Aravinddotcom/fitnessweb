package com.fitnessapp.caloriesproduct;
...
public class FoodproductApplication {
    ...
    public Docket configureSwagger() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                ...
                .apis(RequestHandlerSelectors.basePackage("com.fitnessapp.caloriesproduct.controller")).build()
                .apiInfo(apiInfo());
    }
 
    private ApiInfo apiInfo() {
        return new ApiInfo("Foods calories Api", "Sample API for CaloriesValues", "1.0", "path/to/terms",
